...
const Header = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Header$1, { children: pathname === "/order-confirm" ? /* @__PURE__ */ jsxRuntimeExports.jsx(PrevArrow, { onClick: handleNavigate, style: { cursor: "pointer" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}) });
};
...
const CheckBox = ({ children, isChecked, onClick }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { onClick, children: [
...
const Button = newStyled.button`
  ...
  align-items: center;
`;
const QuantityRegulator = ({ quantity, handleIncrease, handleDecrease }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$1, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleDecrease, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MinusSign, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { variant: "body-3", children: quantity }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleIncrease, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlusSign, {}) })
  ] });
};
...
CartItem.Image = ({ src, alt }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      ...
      alt,
      onError: (e) => {
        e.target.src = "https://www.next-t.co.kr/public/uploads/7b7f7e2138e29e598cd0cdf2c85ea08d.jpg";
      }
    }
  ) });
};
...
const apiClient = async ({ url, options, params }) => {
  ...
  try {
    ...
    if (e instanceof Error)
      throw new Error(e.message || "오류가 발생했습니다. 잠시 후 다시 시도해주세요.");
    return void 0;
  }
};
const cartApi = {
...
const CartPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$3, { children: [
    ...
    cartItemsInfo.count > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Information$2, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPrice, { gap: 12, children: [
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BrowserRouter, { basename: "/react-shopping-cart/", children: [
...
async function enableMocking() {
  const { worker } = await __vitePreload(() => import("./browser-DSqchleN.js"), true ? [] : void 0);
  return worker.start({
    serviceWorker: {
